      ...
      <div className="max-w-7xl mx-auto" ref={ref}>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative w-full h-96 bg-gradient-to-br from-blue-500/20 to-purple-600/20 rounded-lg border border-gray-800 flex items-center justify-center">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(120,119,198,0.3),transparent_70%)] rounded-lg"></div>
              <div className="relative z-10 text-center">
                <div className="text-6xl mb-4">👨‍💻</div>
                <p className="text-gray-300 text-lg">개발자</p>
              </div>
            </div>
          </motion.div>
        </div>
            ...
            {interests.map((interest, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-6 bg-gray-900/50 border border-gray-800 rounded-lg hover:border-blue-500/50 transition-colors duration-200"
                >
